    ...
    <>
          ...
          <div className="flex flex-wrap gap-1.5">
            {DIAGNOSTICO_CONFIG.learningStyles.map(({ label }) => (
              <ChoiceBtn
                key={label}
                label={label}
                selected={estilo === label}
                onClick={() => setEstilo(label)}
              />
            ))}
          </div>
        </Card>
      ...
      <Card className="mb-3">
        ...
        <p className="text-[12px] text-gray-500 dark:text-gray-400 mb-2 mt-1">
          <span className="font-medium text-gray-900 dark:text-gray-100">1.</span> Quais áreas você
        ...
        <p className="text-[12px] text-gray-500 dark:text-gray-400 mb-2">
          <span className="font-medium text-gray-900 dark:text-gray-100">2.</span> Quantas horas por
          semana você consegue estudar?
        </p>
        <div className="flex flex-wrap gap-1.5">
