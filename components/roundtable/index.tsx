                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : sigmaMode
                          ? 'bg-[#1D9E75] hover:bg-[#0F6E56] shadow-[0_4px_16px_rgba(29,158,117,0.3)]'
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? sigmaMode
                              ? 'border-[#1D9E75] shadow-[0_0_12px_rgba(29,158,117,0.4)]'
                              : 'border-purple-500 dark:border-purple-400 shadow-[0_0_12px_rgba(168,85,247,0.4)]'
                            : sigmaMode
                              ? 'border-gray-200 dark:border-gray-700 group-hover:border-[#1D9E75]/40'
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ? sigmaMode
                            ? 'text-[#1D9E75] border-[#1D9E75]/30'
                            : 'text-purple-600 dark:text-purple-400 border-purple-200 dark:border-purple-700'
                          : sigmaMode
                            ? 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-[#1D9E75] group-hover:border-[#1D9E75]/30'
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : sigmaMode
                            ? 'bg-[#1D9E75] hover:bg-[#0F6E56] shadow-[#1D9E75]/20'
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : sigmaMode
                            ? 'from-[#1D9E75] to-[#0F6E56] shadow-[#1D9E75]/30 hover:shadow-[#1D9E75]/40'
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? sigmaMode
                            ? 'bg-[#1D9E75]/95 backdrop-blur-sm border-[#1D9E75]/40 text-white rounded-br-sm shadow-md shadow-[#1D9E75]/20'
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const accentHoverText = sigmaMode
                            ? 'group-hover/bubble:text-[#1D9E75]'
                            : 'hover:text-purple-600 dark:hover:text-purple-400 group-hover/bubble:text-purple-600 dark:group-hover/bubble:text-purple-400';
                          ...
                          >
                            <div
                              className={cn(
                                ...
                                isSpeaking
                                  ? sigmaMode
                                    ? 'border-[#1D9E75] shadow-[0_0_8px_rgba(29,158,117,0.4)]'
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ...
                          : sigmaMode
                            ? 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-[#E1F5EE] hover:text-[#1D9E75] hover:border-[#1D9E75]/30'
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? sigmaMode
                          ? 'border-[#1D9E75] shadow-[0_0_8px_rgba(29,158,117,0.3)]'
                          : 'border-purple-600 dark:border-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.3)]'
                        : sigmaMode
                          ? 'border-white dark:border-gray-700 group-hover:border-[#1D9E75]/30'
