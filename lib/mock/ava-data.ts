...
export const AGENTS: AgentData[] = [
  {
    ...
    subtitle: 'Mapeia lacunas',
    description: 'Mapeando suas lacunas em relação ao ENEM',
    bg: '#E6F1FB',
    color: '#185FA5',
    xpReward: 50,
  },
  ...
  {
    id: 'acompanhamento',
    label: 'Acompanhar Questões',
    subtitle: 'Seu progresso',
    description: 'Analisa seu desempenho e propõe melhorias',
    bg: '#F4EBFF',
    color: '#7E22CE',
    xpReward: 30,
  },
...
const SET_FUNCOES: ActivityQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { key: 'a', value: 'x = 1 e x = 8' },
      { key: 'b', value: 'x = 2 e x = 4' },
      { key: 'c', value: 'x = −2 e x = −4' },
      { key: 'd', value: 'x = 1 e x = 7' },
      { key: 'e', value: 'x = 3 (raiz dupla)' },
    ],
    correctKey: 'b',
    xpReward: 20,
...
const SET_REDACAO: ActivityQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: 'd',
        value: '"Visto que, a situação precisa de atenção" (com vírgula após "visto que")',
      },
...
const SET_SOCIOLOGIA: ActivityQuestion[] = [
  {
    id: 'soc-01',
    area: 'Ciências Humanas — sociologia',
    ...
    options: [
      { key: 'a', value: 'Anomia' },
      { key: 'b', value: 'Alienação' },
      { key: 'c', value: 'Mais-valia' },
      { key: 'd', value: 'Solidariedade mecânica' },
      { key: 'e', value: 'Fato social' },
    ],
    correctKey: 'c',
    xpReward: 20,
  ...
  },
  {
    ...
    options: [
      { key: 'a', value: 'Catolicismo romano' },
      { key: 'b', value: 'Islamismo sunita' },
      { key: 'c', value: 'Protestantismo calvinista' },
      { key: 'd', value: 'Budismo zen' },
      { key: 'e', value: 'Judaísmo ortodoxo' },
    ],
    correctKey: 'c',
    xpReward: 20,
  ...
  {
    id: 'soc-05',
    area: 'Ciências Humanas — filosofia',
...
export const ACTIVITY_SETS: ActivitySet[] = [
  ...
  {
    id: 'eletricidade',
    title: 'Eletricidade e Circuitos',
    area: 'Física',
    icon: '⚡',
  ...
  {
    id: 'sociologia',
    title: 'Sociologia e Filosofia Política',
    area: 'Ciências Humanas',
    icon: '🏛️',
...
export const ENEM_LESSONS: EnemLesson[] = [
  // ── Matemática ──────────────────────────────────────────────────────────────
  {
    ...
    description:
      'O ENEM apresenta funções quadráticas em contextos do cotidiano: trajetória de projéteis, maximização de lucro e otimização de área. O foco é interpretação do vértice e comportamento da parábola, não só resolução algébrica.',
    durationMin: 25,
    status: 'available',
    xpReward: 80,
    proficiencyPct: 31,
    topics: [
      ...
      'Máximo e mínimo de função quadrática',
      'Zeros da função (raízes)',
      'Interpretação de gráficos em contexto real',
      'Problemas de otimização ENEM',
    ],
  },
  {
    id: 'enem-fn-02',
    ...
    description:
      'Crescimento e decaimento exponencial são recorrentes no ENEM: juros compostos, radioatividade, crescimento populacional. Logaritmos aparecem na escala Richter, pH e decibéis.',
    durationMin: 28,
    status: 'available',
    xpReward: 75,
    proficiencyPct: 44,
    topics: [
      ...
      'Equações exponenciais por logaritmação',
      'Aplicações: juros, pH, Richter, decibéis',
    ],
  },
  {
    id: 'enem-stat-01',
    ...
    description:
      'Estatística representa ~15% das questões de matemática no ENEM. A banca exige leitura crítica de tabelas, gráficos de barras, histogramas e boxplots, além de medidas de tendência central.',
    durationMin: 22,
    status: 'available',
    xpReward: 70,
    proficiencyPct: 50,
    topics: [
      ...
      'Mediana e moda: quando usar cada uma',
      'Leitura de gráficos: barras, pizza, histograma',
      'Análise de boxplot e dispersão',
      'Probabilidade clássica e frequentista',
    ],
  },
  {
    id: 'enem-geo-01',
    ...
    description:
      'Prismas, pirâmides, cilindros, cones e esferas são frequentes no ENEM em problemas de embalagens, arquitetura e engenharia. A banca cobra cálculo de volume, área e planificação.',
    durationMin: 25,
    status: 'locked',
    xpReward: 75,
    proficiencyPct: 65,
    topics: [
      ...
      'Volume de cilindro, cone e esfera',
      'Área lateral e total dos sólidos',
      'Planificação de sólidos geométricos',
      'Problemas aplicados: embalagens e arquitetura',
    ],
  },
  {
    id: 'enem-fin-01',
    ...
    description:
      'Juros simples, compostos e desconto comercial aparecem em contextos de empréstimos, investimentos e compras parceladas. O ENEM prioriza interpretação e montagem de equações a partir de textos.',
    durationMin: 20,
    status: 'locked',
    xpReward: 65,
    proficiencyPct: 42,
    topics: [
      'Juro simples: M = C(1 + it)',
      'Juro composto: M = C(1 + i)ⁿ',
      'Desconto comercial e bancário',
      'Taxa equivalente e proporcional',
      'Leitura de tabela de financiamento',
    ],
  },
  ...
  // ── Ciências da Natureza ─────────────────────────────────────────────────────
  {
    ...
    description:
      'Circuitos elétricos, potência e consumo de energia elétrica são os tópicos de física mais cobrados no ENEM. Problemas envolvem conta de luz, chuveiro e instalações residenciais como contexto.',
    durationMin: 28,
    status: 'available',
    xpReward: 80,
    proficiencyPct: 33,
    topics: [
      'Lei de Ohm: V = R·I',
      'Potência elétrica: P = V·I = V²/R = R·I²',
      'Circuitos em série e paralelo',
      'Resistência equivalente',
      'Consumo em kWh e conta de energia',
    ],
  },
  {
    id: 'enem-fis-02',
    ...
    description:
      'Trabalho, energia cinética e potencial são cobrados no ENEM em contextos de montanhas-russas, freio de carro, lançamento de projéteis e geração de energia hidrelétrica.',
    durationMin: 25,
    status: 'locked',
    xpReward: 75,
    proficiencyPct: 40,
  ...
  },
  {
    ...
    description:
      'Oxidação, redução, pilhas e eletrólise são cobrados no ENEM em contextos de corrosão de metais, baterias de celular, galvanoplastia e proteção catódica de navios e oleodutos.',
    durationMin: 30,
    status: 'available',
    xpReward: 80,
    proficiencyPct: 39,
    topics: [
      'Número de oxidação (nox): regras gerais',
      'Identificar oxidação e redução na equação',
      'Pilha de Daniell: funcionamento e ddp',
      'Eletrólise ígnea e aquosa',
      'Aplicações: corrosão, galvanoplastia, baterias',
    ],
  },
  {
    id: 'enem-qui-02',
    ...
    description:
      'Hidrocarbonetos, álcoois, ácidos carboxílicos e ésteres aparecem no ENEM associados a combustíveis, medicamentos, aromas e cosméticos. A banca cobra nomenclatura IUPAC e reações características.',
    durationMin: 30,
    status: 'completed',
    xpReward: 75,
    proficiencyPct: 55,
    topics: [
      ...
      'Álcoois, éteres, aldeídos e cetonas',
      'Ácidos carboxílicos e ésteres: formação e hidrólise',
  ...
  },
  {
    ...
    description:
      'Genética mendelliana, herança ligada ao sexo, alelos múltiplos e biotecnologia (PCR, transgênicos, DNA forense) são temas recorrentes no ENEM, frequentemente associados a dilemas éticos.',
    durationMin: 32,
    status: 'available',
    xpReward: 80,
    proficiencyPct: 45,
    topics: [
      'Leis de Mendel: dominância e segregação',
      'Herança ligada ao sexo: daltonismo, hemofilia',
      'Alelos múltiplos: sistema ABO e Rh',
      'Engenharia genética: transgênicos e OGM',
      'DNA e técnicas de biologia molecular',
    ],
  },
  {
    id: 'enem-bio-02',
    ...
    description:
      'Cadeias alimentares, biomas brasileiros, impactos ambientais e sustentabilidade aparecem frequentemente no ENEM, especialmente em questões que cruzam ciências com atualidades e cidadania.',
    durationMin: 22,
    status: 'completed',
    xpReward: 70,
    proficiencyPct: 71,
    topics: [
      'Cadeia e teia alimentar: produtores e consumidores',
      'Pirâmides ecológicas: energia, biomassa, número',
      'Biomas brasileiros: características e fauna',
      'Desmatamento, erosão e poluição',
  ...
  // ── Redação ──────────────────────────────────────────────────────────────────
  {
    ...
    description:
      'A C3 avalia se o candidato seleciona, relaciona e organiza informações para defender seu ponto de vista. É a competência com maior potencial de perda de pontos entre candidatos de nível médio.',
    durationMin: 30,
    status: 'available',
    xpReward: 100,
    proficiencyPct: 48,
    topics: [
      'Diferença entre argumento e opinião',
      'Tipos de argumento: autoridade, exemplificação, causa-efeito',
      'Como usar a coletânea sem copiar',
      'Estrutura do parágrafo argumentativo: tópico + desenvolvimento',
      'Progressão temática: cada parágrafo avança a tese',
    ],
  },
  {
    id: 'enem-red-02',
    ...
    description:
      'A proposta de intervenção (C5) deve apresentar 5 elementos: agente, ação, meio/modo, finalidade e detalhamento. Propostas genéricas ou incompletas perdem até 120 pontos nessa competência.',
    durationMin: 25,
    status: 'available',
    xpReward: 100,
    proficiencyPct: 68,
    topics: [
      'Os 5 elementos da proposta: agente, ação, meio, finalidade, detalhamento',
      'Como identificar o agente correto para cada problema',
      'Exemplos de propostas nota 200 comentadas',
      'Conectivos para a proposta: "a fim de que", "por meio de"',
      'Erros mais comuns: proposta desvinculada da tese',
    ],
  },
  {
    id: 'enem-red-03',
    ...
    description:
      'A C4 avalia o uso de mecanismos linguísticos que garantem a progressão e articulação entre as partes do texto. O ENEM penaliza textos que repetem conectivos ou os usam de forma inadequada.',
    durationMin: 22,
    status: 'available',
    xpReward: 100,
    proficiencyPct: 55,
    topics: [
      'Conectivos de adição, oposição, causa e consequência',
      'Referenciação: pronomes, sinônimos e hiperônimos',
      'Paralelismo e concordância como coesão',
      'Sequenciação temporal e espacial',
      'Análise de redações com erros de coesão',
    ],
  },
  {
    id: 'enem-red-04',
    ...
    description:
      'A C1 avalia o domínio da modalidade escrita formal. Erros de regência, concordância, crase e pontuação comprometem diretamente a nota. Candidatos com C1 baixa raramente superam 700 pontos.',
    durationMin: 25,
    status: 'completed',
    xpReward: 80,
    proficiencyPct: 80,
    topics: [
      ...
      'Regência verbal dos verbos mais cobrados',
      'Crase: quando usar e quando não usar',
      'Pontuação: vírgula antes de "que" e "se"',
      'Fragmentação e período excessivamente longo',
    ],
  },
  {
    id: 'enem-red-05',
    ...
    description:
      'A C2 avalia se o candidato compreende a proposta de redação e se desenvolve o texto dentro da tipologia dissertativo-argumentativa. Fuga ao tema resulta em nota zero.',
    durationMin: 20,
    status: 'completed',
    xpReward: 80,
    proficiencyPct: 72,
    topics: [
      'Estrutura da dissertação: introdução, desenvolvimento, conclusão',
      'Como analisar a proposta e evitar fuga ao tema',
      'Introdução com contextualizaçao + tese clara',
      'Tese, antítese e síntese no desenvolvimento',
      'Conclusão retomando a tese com proposta',
    ],
  },
  ...
  // ── Ciências Humanas ─────────────────────────────────────────────────────────
  {
    ...
    description:
      'Hobbes, Locke e Rousseau são os filósofos mais cobrados no ENEM. A banca apresenta trechos dos contratualistas e pede que o candidato identifique características do pensamento de cada autor.',
    durationMin: 28,
    status: 'available',
    xpReward: 75,
    proficiencyPct: 52,
    topics: [
      'Contrato social: Hobbes (Leviatã), Locke e Rousseau',
      'Estado de natureza em cada autor',
      'Iluminismo: razão, liberdade e progresso',
      'Kant: imperativo categórico e autonomia moral',
      'Aplicação contemporânea: democracia e direitos',
    ],
  },
  {
    id: 'enem-soc-01',
    ...
    description:
      'Marx, Weber e Durkheim formam a tríade mais cobrada no ENEM. As questões apresentam situações contemporâneas (gig economy, fake news, racismo estrutural) pedindo análise sociológica.',
    durationMin: 25,
    status: 'available',
    xpReward: 70,
    proficiencyPct: 60,
    topics: [
      'Marx: mais-valia, alienação e luta de classes',
      'Weber: ação social, burocracia e ética protestante',
      'Durkheim: fato social, anomia e solidariedade',
      'Globalização: impactos culturais e econômicos',
  ...
  },
  {
    ...
    description:
      'O período republicano brasileiro, especialmente a Era Vargas, o regime militar (1964–85) e a redemocratização, é recorrente no ENEM associado a fontes primárias como cartazes, fotografias e documentos oficiais.',
    durationMin: 30,
    status: 'completed',
    xpReward: 75,
    proficiencyPct: 81,
    topics: [
      'República Velha: coronelismo e oligarquias',
      'Era Vargas: Estado Novo e trabalhismo',
      'Regime militar: AI-5, censura e milagre econômico',
      'Redemocratização: Diretas Já e Constituição de 1988',
      'Análise de fontes primárias: cartazes e discursos',
    ],
  },
  {
    id: 'enem-geo-hum-01',
    ...
    description:
      'A geopolítica contemporânea aparece no ENEM em questões que exigem leitura de mapas temáticos, análise de conflitos regionais e compreensão dos impactos da globalização nas periferias do mundo.',
    durationMin: 25,
    status: 'locked',
    xpReward: 70,
    proficiencyPct: 68,
    topics: [
      ...
      'Blocos econômicos: UE, BRICS, MERCOSUL',
      'Globalização assimétrica e hegemonias',
      'Leitura de mapas temáticos e cartogramas',
    ],
  },
  ...
  // ── Linguagens ───────────────────────────────────────────────────────────────
  {
    ...
    description:
      'A prova de linguagens exige inferência (o que o texto implica mas não diz) e reconhecimento de intertextualidade (referências a outros textos, gêneros e épocas). São as habilidades com maior índice de erro.',
    durationMin: 22,
    status: 'completed',
    xpReward: 65,
    proficiencyPct: 78,
    topics: [
      'Inferência e implícitos textuais',
      'Intertextualidade: citação, paráfrase, paródia',
      'Ironia, ambiguidade e subentendidos',
      'Gêneros textuais: charge, tirinhas, poemas',
      'Linguagem verbal e não verbal em conjunto',
    ],
  },
  {
    id: 'enem-lit-01',
    ...
    description:
      'O ENEM cobra reconhecimento de características estilísticas, não memorização de datas. Modernismo, realismo e contemporaneidade são as escolas mais frequentes, sempre associadas a fragmentos de obras.',
    durationMin: 25,
    status: 'completed',
    xpReward: 70,
    proficiencyPct: 74,
    topics: [
      'Modernismo: 1ª, 2ª e 3ª geração',
      'Semana de Arte Moderna: propósitos e autores',
      'Realismo e naturalismo: características e contexto',
      'Literatura contemporânea: pluralidade e fragmentação',
      'Análise estilística de fragmentos literários',
    ],
  },
  {
    id: 'enem-sem-01',
    ...
    description:
      'O ENEM apresenta anúncios publicitários, memes, infográficos e capas de revista pedindo análise da relação entre elementos verbais e visuais. Semiótica é a ferramenta teórica para essas questões.',
    durationMin: 20,
    status: 'locked',
    xpReward: 70,
    proficiencyPct: 66,
    topics: [
      'Signo, significante e significado (Saussure)',
      'Ícone, índice e símbolo (Peirce)',
      'Análise de anúncios: texto verbal e imagem',
      'Discurso publicitário: persuasão e ideologia',
      'Mídias digitais: memes, hipertexto e remix',
    ],
  },
];
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    iconColor: '#185FA5',
    title: 'Mapa completo',
    description: 'Completou o diagnóstico ENEM',
    xp: 50,
    unlocked: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Completou 1 simulado ENEM',
    xp: 120,
    unlocked: true,
  },
  {
    ...
    icon: 'chart-line',
    iconColor: '#3B6D11',
    title: 'Lacuna fechada',
    description: 'Supere 70% em uma área crítica',
    xp: 0,
    unlocked: false,
  ...
  },
  {
    ...
    iconColor: '#BA7517',
    title: 'Mestre ENEM',
    description: 'Acima de 80% em todas as áreas',
    xp: 0,
    unlocked: false,
    progress: 'Bloqueada',
  },
...
export const LESSONS: Lesson[] = [
  {
    ...
    description: 'Conceitos de números naturais, inteiros e sua representação na reta numérica.',
    durationMin: 45,
    date: '2026-05-04',
    weekday: 'Segunda',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Números naturais', 'Números inteiros', 'Reta numérica', 'Valor absoluto'],
  },
  {
    id: 'mat-02',
    subjectId: 'matematica',
    title: 'Máximo Divisor Comum (MDC)',
    description: 'Cálculo do MDC usando o método da decomposição em fatores primos.',
    durationMin: 50,
    date: '2026-05-06',
    weekday: 'Quarta',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Fatores primos', 'Decomposição', 'Algoritmo de Euclides', 'Aplicações práticas'],
  },
  {
    id: 'mat-03',
    subjectId: 'matematica',
    title: 'Mínimo Múltiplo Comum (MMC)',
    description: 'Cálculo do MMC e suas aplicações na resolução de problemas do cotidiano.',
    durationMin: 50,
    date: '2026-05-11',
    weekday: 'Segunda',
    week: 2,
    weekLabel: '11 a 15 de maio',
    status: 'completed',
    topics: ['Múltiplos', 'MMC', 'Problemas com MMC', 'Relação entre MDC e MMC'],
  },
  {
    id: 'mat-04',
    subjectId: 'matematica',
    title: 'Frações: Conceito e Representação',
    description: 'Introdução às frações, tipos de frações e formas de representação.',
    durationMin: 60,
    date: '2026-05-13',
    weekday: 'Quarta',
    week: 2,
  ...
  },
  {
    id: 'mat-05',
    subjectId: 'matematica',
    title: 'Frações: Adição e Subtração',
    description: 'Operações de adição e subtração com frações de mesmo e diferente denominador.',
    durationMin: 60,
    date: '2026-05-26',
    weekday: 'Segunda',
    week: 3,
    weekLabel: '25 a 29 de maio',
    status: 'available',
    topics: [
  ...
  },
  {
    id: 'mat-06',
    subjectId: 'matematica',
    title: 'Frações: Multiplicação e Divisão',
    description: 'Operações de multiplicação e divisão com frações e números mistos.',
    durationMin: 60,
    date: '2026-06-02',
    weekday: 'Segunda',
    week: 4,
    weekLabel: '1 a 5 de junho',
    status: 'locked',
    topics: [
  ...
  },
  {
    id: 'por-01',
    subjectId: 'portugues',
    title: 'Tipos de Texto: Narrativo',
    description: 'Características e estrutura do texto narrativo.',
    durationMin: 50,
    date: '2026-05-05',
    weekday: 'Terça',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Narrador', 'Personagens', 'Tempo e espaço', 'Enredo'],
  },
  {
    id: 'por-02',
    subjectId: 'portugues',
    title: 'Morfologia: Substantivos',
    description: 'Classificação dos substantivos.',
    durationMin: 45,
    date: '2026-05-07',
    weekday: 'Quinta',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Substantivos comuns e próprios', 'Concretos e abstratos', 'Coletivos', 'Flexão'],
  },
  {
    id: 'por-03',
    subjectId: 'portugues',
    title: 'Morfologia: Adjetivos',
    description: 'Funções e classificação dos adjetivos.',
    durationMin: 45,
    date: '2026-05-19',
    weekday: 'Terça',
    week: 3,
    weekLabel: '18 a 22 de maio',
    status: 'completed',
    topics: ['Adjetivo pátrio', 'Locução adjetiva', 'Graus do adjetivo', 'Adjetivação'],
  },
  {
    id: 'por-04',
    subjectId: 'portugues',
    title: 'Morfologia: Verbos',
    description: 'Conjugação verbal: modos, tempos e pessoas do verbo.',
    durationMin: 60,
    date: '2026-05-28',
    weekday: 'Quinta',
    week: 4,
    weekLabel: '25 a 29 de maio',
    status: 'available',
    topics: ['Modo indicativo', 'Modo subjuntivo', 'Modo imperativo', 'Verbos irregulares'],
  },
  {
    id: 'cie-01',
    subjectId: 'ciencias',
    title: 'Célula: Unidade da Vida',
    description: 'Estrutura e funções das células procariontes e eucariontes.',
    durationMin: 55,
    date: '2026-05-05',
    weekday: 'Terça',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Membrana celular', 'Núcleo', 'Citoplasma', 'Organelas'],
  },
  {
    id: 'cie-02',
    subjectId: 'ciencias',
    title: 'Divisão Celular: Mitose',
    description: 'Fases da mitose.',
    durationMin: 60,
    date: '2026-05-12',
    weekday: 'Terça',
    week: 2,
    weekLabel: '11 a 15 de maio',
    status: 'completed',
    topics: ['Prófase', 'Metáfase', 'Anáfase', 'Telófase'],
  },
  {
    id: 'cie-03',
    subjectId: 'ciencias',
    title: 'Sistema Digestório',
    description: 'Órgãos e funcionamento do sistema digestório humano.',
    durationMin: 55,
    date: '2026-05-26',
    weekday: 'Segunda',
    week: 4,
    weekLabel: '25 a 29 de maio',
    status: 'available',
    topics: ['Boca e esôfago', 'Estômago', 'Intestino', 'Fígado e pâncreas'],
  },
  {
    id: 'his-01',
    subjectId: 'historia',
    title: 'Pré-História: Origens da Humanidade',
    description: 'Do Homo sapiens às primeiras sociedades.',
    durationMin: 50,
    date: '2026-05-06',
    weekday: 'Quarta',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Evolução humana', 'Paleolítico', 'Arte rupestre', 'Nomadismo'],
  },
  {
    id: 'his-02',
    subjectId: 'historia',
    title: 'Antigas Civilizações: Egito',
    description: 'Civilização egípcia.',
    durationMin: 55,
    date: '2026-05-13',
    weekday: 'Quarta',
    week: 2,
    weekLabel: '11 a 15 de maio',
    status: 'available',
    topics: ['Faraós', 'Escrita hieroglífica', 'Pirâmides', 'Rio Nilo'],
  },
  {
    id: 'geo-01',
    subjectId: 'geografia',
    title: 'Cartografia: Leitura de Mapas',
    description: 'Elementos dos mapas e escalas.',
    durationMin: 50,
    date: '2026-05-07',
    weekday: 'Quinta',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Elementos do mapa', 'Escala', 'Projeções cartográficas', 'Rosa dos ventos'],
  },
  {
    id: 'geo-02',
    subjectId: 'geografia',
    title: 'Relevo Brasileiro',
    description: 'As principais formas de relevo do Brasil.',
    durationMin: 55,
    date: '2026-05-14',
    weekday: 'Quinta',
    week: 2,
    weekLabel: '11 a 15 de maio',
    status: 'available',
    topics: ['Planaltos', 'Planícies', 'Depressões', 'Serra do Mar'],
  },
  {
    id: 'ing-01',
    subjectId: 'ingles',
    title: 'Simple Present: Daily Routines',
    description: 'Uso do simple present para descrever rotinas.',
    durationMin: 45,
    date: '2026-05-05',
    weekday: 'Terça',
    week: 1,
    weekLabel: '4 a 8 de maio',
    status: 'completed',
    topics: ['Afirmativas e negativas', 'Interrogativas', 'Advérbios de frequência', 'Vocabulary'],
  },
  {
    id: 'ing-02',
    subjectId: 'ingles',
    title: 'Simple Past: Actions',
    description: 'Verbos regulares e irregulares no passado simples.',
    durationMin: 50,
    date: '2026-05-12',
    weekday: 'Terça',
    week: 2,
    weekLabel: '11 a 15 de maio',
    status: 'available',
    topics: ['Regular verbs', 'Irregular verbs', 'Time expressions', 'Past stories'],
  },
];
